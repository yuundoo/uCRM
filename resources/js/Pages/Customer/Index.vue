            ...
            <section class="text-gray-600 body-font">
              <div class="container px-5 py-8 mx-auto">
                ...
                <div class="flex w-full pl-4 mx-auto my-4 space-x-2 lg:w-2/3">
                  ...
                  <button @click="searchCustomers" class="px-3 py-1 text-sm text-white bg-blue-400 rounded hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-300">検索</button>

                  <Link as="button" :href="route('customers.index')" class="px-3 py-1 text-sm text-white bg-red-400 rounded hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-300">リセット</Link>

                  <Link :href="route('customers.create')" as="button" class="px-3 py-1 text-sm text-white bg-indigo-400 rounded hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-300">顧客登録</Link>
                </div>
