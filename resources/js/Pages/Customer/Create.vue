                ...
                <div class="container px-5 py-8 mx-auto">
                  <div class="mx-auto lg:w-1/2 md:w-2/3">
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="w-full p-2">
                        <div class="relative">
                          <label for="password" class="text-sm leading-7 text-gray-600">暗証番号</label>
                          <input type="password" id="password" name="password" v-model="form.password" class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200" />
                          <div v-if="errors.password" class="mt-2 text-red-400">
                            {{ errors.password }}
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="w-full p-2">
                        <div class="relative">
                          <label for="password_confirmation" class="text-sm leading-7 text-gray-600">暗証番号確認</label>
                          ...
                          <div v-if="errors.password_confirmation" class="mt-2 text-red-400">
                      ...
                      <div class="w-full p-2">
                        <button class="flex px-8 py-2 mx-auto text-lg text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600">顧客登録</button>
                      </div>
                    </div>
                  </div>
                </div>
