                ...
                >
                    ...
                    <div class="flex items-start w-full px-4 py-2 space-x-4">
                        ...
                        >
                            ...
                            <div>
                                デザイナー: {{ reservation.stylelist.name }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        v-if="reservation.status === 'cancel'"
                        class="flex flex-col items-center justify-center w-1/6 mr-10 font-semibold text-red-500"
                    >
                        キャンセル済
                    </div>
                    ...
                    <div
                        v-if="showModalForId === reservation.id"
                    ...
                    >
                        ...
                        >
                            <div class="mt-3 text-center">
                                <h3
                                    class="p-3 text-lg font-medium leading-6 text-gray-900"
                                >
                                    {{ reservation.item.name }}
                                </h3>
                                ...
                                <div class="py-3 mt-2 px-7">
                                    ...
                                    <textarea
                                        v-model="form.reason"
                                        class="w-full px-3 py-2 mt-1 text-sm bg-white border rounded-md"
                                    ></textarea>
                                </div>
                                <div class="items-center px-4 py-3">
                                    ...
                                    <button
                                        id="cancel-btn"
                                        @click="closeModal"
                                        class="w-5/12 px-4 py-2 text-base font-medium text-purple-500 bg-white rounded-md shadow-sm hover:text-purple-700 focus:outline-none focus:ring-2 focus:ring-green-300"
                                    >
                                        いいえ
                                    </button>
                                </div>
