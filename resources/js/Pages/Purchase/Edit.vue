...
const updatePurchase = (id) => {
  ...
  Inertia.put(route('purchases.update', { purchase: id }), form, console.log(form));
};
...
<template>
  ...
  <AuthenticatedLayout>
    <template #header>
      <h2 class="text-xl font-semibold leading-tight text-gray-800">予約履歴編集</h2>
    </template>
    <div class="py-12">
                    ...
                    <div class="flex flex-wrap -m-2">
                      <div class="w-full p-2">
                        <div class="relative">
                          ...
                          <input type="date" id="date" v-model="selectedDate" :min="today" :max="maxDateStr" class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200" />
                        </div>
                      </div>
                      ...
                      <div class="w-full p-2">
                        <div class="relative">
                          ...
                          <div v-if="props.errors.time" class="mt-2 text-red-400">
                            {{ props.errors.time }}
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="w-full p-2">
                        <div class="relative">
                          ...
                          <br />
                          <input type="text" id="customer" name="customer" :value="props.reservation.customer.username" class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200" />
                        </div>
                      ...
                      <div class="w-full p-2">
                        <div class="relative">
                          ...
                          <div v-if="props.errors.item_id" class="mt-2 text-red-400">
                      ...
                      <div class="w-full p-2">
                        <div class="relative">
                          ...
                          <select id="designer" v-model="selectedStylist" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded focus:border-indigo-500 focus:bg-white">
                            ...
                            <option v-for="stylist in props.stylelists" :key="stylist.id" :value="stylist.id">
                              {{ stylist.name }}
                            </option>
                          </select>
                          <div v-if="props.errors.stylelist_id" class="mt-2 text-red-400">
                            {{ props.errors.stylelist_id }}
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="w-full p-2">
                        <div class="relative">
                          ...
                          <div class="flex items-center mt-2">
                            <input type="radio" id="is_selling_on" name="status" v-model="form.status" value="reservated" class="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500" />
                            <label for="is_selling_off" class="ml-2 text-sm font-medium text-gray-600">未キャンセル</label>
                          </div>
                          <div class="flex items-center mt-2">
                            <input type="radio" id="status_off" name="status" v-model="form.status" value="cancel" class="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500" />
                            <label for="is_selling_off" class="ml-2 text-sm font-medium text-gray-600">キャンセル済</label>
                          </div>
                          <div v-if="props.errors.status" class="mt-2 text-red-400">
                            {{ props.errors.status }}
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="w-full p-2">
                        <div>
                          <button class="px-6 py-3 text-white bg-indigo-500 rounded hover:bg-indigo-600 focus:outline-none focus:shadow-outline">編集する</button>
                        </div>
                      </div>
                    </div>
                  </div>
