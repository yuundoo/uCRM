...
<template>
   ...
   <AuthenticatedLayout>
      <template #header>
         <Link as="button" :href="route('stylelists.index')" class="text-xl font-semibold leading-tight text-gray-800">
            デザイナー詳細
         </Link>
      </template>
      <div
      ...
      >
         <div class="w-full max-w-sm overflow-hidden text-center bg-white rounded-lg shadow-lg">
            ...
            <div class="px-6 py-4">
               ...
               <!-- 인스타그램 링크 -->
               <div class="mb-4">
                  <a href="https://www.instagram.com/yuki_chae.a" class="text-blue-500 hover:text-blue-800">
                     https://www.instagram.com/tyi02038
                  </a>
               </div>
               <!-- 소셜 미디어 버튼 -->
               <div class="flex justify-center gap-4">
                  <button class="px-4 py-2 font-bold text-white bg-gray-500 rounded-full hover:bg-gray-700">
                     問い合わせ
                  </button>
                  <button class="px-4 py-2 font-bold text-white bg-gray-500 rounded-full hover:bg-blue-700">
                     共有
                  </button>
               </div>
            </div>
